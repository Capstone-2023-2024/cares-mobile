...
import BackHeader4Chat from '~/components/BackHeader4Chat';
...
const Chats = () => {
  const [] = useState('');
  const [, setMultipleFile] = useState([]);
    ...
    <View>
      ...
      <View style={styles.chat}>
        ...
        <View style={styles.categories}>
          <TouchableOpacity>
            <Text
              style={{fontWeight: '500', color: 'black', paddingLeft: '2%'}}>
              Complains
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity>
            <Text
              style={{fontWeight: '500', color: 'black', paddingRight: '2%'}}>
              Announcements
            </Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  chatbox: {
    ...
    marginTop: '50%',
    width: '71%',
    height: 460, // Limit the maximum height of the chatbox to avoid it going beyond the screen
